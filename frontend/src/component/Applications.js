...
const ApplicationTile = (props) => {
  ...
  const handleCloseWp = () => setShow(false);
  const handleShowWp = () => setShow(true);
    ...
    <Paper className={classes.jobTileOuter} elevation={3}>
      <Grid container>
        <Grid container item xs={9} spacing={1} direction="column">
          ...
          <Grid item>Number : {application.recruiter.contactNumber}</Grid>
          <Grid item>
            Duration :{" "}
      ...
      >
        {applications.length > 0 ? (
          ...
          <Typography variant="h5" style={{ textAlign: "center" }}>
            {showSpinner ? <CircularProgress /> : "No Applications Found"}
          </Typography>
        )}
      </Grid>
    </Grid>
